      ...
      <div className="section-container relative z-10 flex flex-col items-center gap-12 lg:flex-row lg:gap-16">
        ...
        >
          <div className="profile-halo relative h-56 w-56 overflow-hidden rounded-full border-2 border-primary/30 sm:h-64 sm:w-64">
            <img src={profileImg} alt="Sakthi Kumar B" className="h-full w-full object-cover" />
          </div>
        </motion.div>
        ...
        <div className="text-center lg:text-left">
          ...
          >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-primary/40 bg-primary/10 px-5 py-2.5 text-sm font-medium text-primary transition-all hover:bg-primary/20"
            >
              <FileText size={16} /> Digital Resume
            </button>
            <a
              href="#contact"
